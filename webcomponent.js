(function () {
    ...
    tmpl.innerHTML = `<link rel="stylesheet" type="text/css" href="https://sacswde.github.io/SACDatePicker/light.css"/>`;
    ...
    class DatePicker extends HTMLElement {
        ...
        async checkForUpdates() {
            try {
                const contribution = await (await fetch("https://sacswde.github.io/SACDatePicker/datepicker.json")).json();
        ...
        set darktheme(value) {
            this.querySelector("link").setAttribute("href", "https://sacswde.github.io/SACDatePicker/" +
